...
# modified version of https://github.com/hlord2000/nordic-lib-kicad/blob/main/PCM/create_pcm_archive.sh
...
echo DOWNLOAD_URL="https:\/\/github.com\//HydrogenPlumbing\/hydrogen-kicad-library\/releases\/download\/$VERSION\/KiCAD-PCM-$VERSION.zip" >> $GITHUB_ENV
